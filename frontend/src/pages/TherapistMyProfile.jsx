...
const TherapistProfile = () => {
  const { authUser, getFollowers, checkAuth, isCheckingAuth, getFollowings } =
    useAuthStore();
  ...
  useEffect(() => {
    const fetchEntries = async (id) => {
      ...
      try {
        ...
        console.log(
          "error in TherapistProfile while fetching journal entries ",
          error
        );
      } finally {
          ...
          <div className="aboutUser border-b-2 pb-6 ">
            <div className="flex flex-col  ">
              ...
              <div className="basis-3/5">
                ...
                {/* Therapist details added here */}
                <div className="therapist-details mt-2 space-y-1">
                    <p className="text-sm text-gray-700">
                        License:{" "}
                        <span className="font-bold">
                            {authUser.licenseNumber || "Not Provided"}
                        </span>
                    </p>
                    <p className="text-sm text-gray-700">
                        Qualifications:{" "}
                        <span className="font-bold">
                            {authUser.qualifications || "Not Provided"}
                        </span>
                    </p>
                    <p className="text-sm text-gray-700">
                        Specialities:{" "}
                        <span className="font-bold">
                            {authUser.specialities || "Not Provided"}
                        </span>
                    </p>
                    <p className="text-sm text-gray-700">
                        Experience:{" "}
                        <span className="font-bold">
                            {authUser.experienceYears || "-"} years
                        </span>
                    </p>
                </div>
          ...
          <div className="post-and-journal-area flex flex-row">
            ...
            <div className="pl-4">
              {isEntryLoading ? (
                ...
                <>
                  <h1 className="text-3xl font-bold text-brand pb-4">
